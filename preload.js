...
contextBridge.exposeInMainWorld('srtAPI', {
  ...
  importProjectMedia: (request) => ipcRenderer.invoke('project-assets:import', request),
  listProjectMedia: (request) => ipcRenderer.invoke('project-assets:list', request),
  validateProjectAssets: (request) => ipcRenderer.invoke('project-assets:validate', request),
