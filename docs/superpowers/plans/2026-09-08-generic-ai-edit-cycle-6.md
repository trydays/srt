...
- [ ] Write RED tests against public APIs before implementation. Examples:
...
- [ ] Update internal-completion and user-visible-result records separately with exact tests, failures, time, artifact paths and remaining boundaries. Commit records locally and stop; no auto push or Cycle7.
